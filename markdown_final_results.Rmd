...
pdf("/Users/stijnhantson/Documents/Documents/articulos/en_proceso/VIIRS_ros/mean_vs_max_ros_v1.pdf", width = 5, height = 5)
...
pdf("/Users/stijnhantson/Documents/Documents/articulos/en_proceso/VIIRS_ros/figure1_v1.pdf", width = 10, height = 5)
par(mfrow=c(1,2))
par(mar=c(4, 4, 1,0.1))
par(mgp=c(2.3,1,0))
...
pdf("/Users/stijnhantson/Documents/Documents/articulos/en_proceso/VIIRS_ros/sup_figure1_v1.pdf", width = 10, height = 5)
par(mfrow=c(1,2))
par(mar=c(4, 4, 1,0.1))
par(mgp=c(2.3,1,0))
...
marks=c(0.01,0.1,1,10)
pdf("/Users/stijnhantson/Documents/Documents/articulos/en_proceso/VIIRS_ros/fig_basa_ros_forest_v3.pdf", width = 5, height = 5)
...
bndy_list = list.files(mtbs_dir_year, pattern = "burn_bndy.shp$", recursive = F, full.names=T)
...
dnbr_ext = extract(dnbr,fires)
rdnbr_ext = extract(rdnbr,fires)
dnbr_all[k]=mean(unlist(dnbr_ext),na.rm=T)
rdnbr_all[k]=mean(unlist(rdnbr_ext),na.rm=T)
